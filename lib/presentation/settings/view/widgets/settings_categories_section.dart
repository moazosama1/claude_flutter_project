...
/// Navigates to the full Categories management screen. Kept as a single-row
/// group so it sits alongside the other Settings blocks.
class SettingsCategoriesSection extends StatelessWidget {
  const SettingsCategoriesSection({super.key});
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        context.l10n.manageCategoriesDesc,
